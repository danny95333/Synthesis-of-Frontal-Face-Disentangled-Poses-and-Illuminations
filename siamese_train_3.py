...
saveFile = open('/home/shumao/wyw_files/siamese_output_3/record.txt', 'w')
saveFile.write("niter:" + str(50000) + "\n")
saveFile.write("---lr:" + str(0.0005) + "\n")
saveFile.write("beta1:" + str(0.7) + "\n")
saveFile.write("W:-1-x-x-x-x-x-" + "\n")
saveFile.write("second model" + "\n")
saveFile.write("after load model from: 0620")
logger = Logger('./log_1');
...
parser.add_argument('--outf', default='/home/shumao/wyw_files/siamese_output_3', help='folder to output images and model checkpoints')
...
parser.add_argument('--modelPath', default='/home/shumao/wyw_files/siamese_output_0620/netS_100000.pth', help='which dataset to train on')
...
netS = Siamese()
netS.load_state_dict(torch.load('/home/shumao/wyw_files/siamese_output_0620/netS_100000.pth'))
if(opt.cuda):
    netS.cuda()
